...
df = pd.read_csv('C:/Users/asanw/OneDrive/Desktop/CS 530/Final Project/meshtal_final.txt', sep='\s+', names=column_names, skiprows=14)  # Replace n with the number of rows to skip
...
plt.title('TNeutron Flux Distribution in PUR-1 Reactor Core')
